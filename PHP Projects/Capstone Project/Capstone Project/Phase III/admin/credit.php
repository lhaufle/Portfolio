...
addCredit($firstName, $lastName, $email, $officeID, $phNumber); 
...
<?php
  displayJumbo("Credit", "Add An Analyst");
?> 
...
<form action="creditUpdate.php" method="POST">
   ...
   <div class="form-group">
     <label for="selectCredit">Select Analyst to Edit or Delete:</label>
    <select multiple class="form-control" id="selectCredit" name="credit">
       <?php displayCreditList()//replace after testing?>
    </select>
   </div>
