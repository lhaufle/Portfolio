...
session_start();
  ...
  $age = strip_tags(checkPost($_POST['factOne'], "Four")); 
  $food = strip_tags(checkPost($_POST['factTwo'], "Candy"));
  $movie = strip_tags(checkPost($_POST['factThree'], "Beauty and the Beast"));
  $goal = strip_tags(checkPost($_POST['factFour'], "A princess--for now"));
?>
